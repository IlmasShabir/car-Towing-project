...
import { FiMenu, FiMinimize2, FiMaximize2, FiChevronRight, FiSearch } from 'react-icons/fi';
  ...
  return (
    <header className="a-topbar">
      ...
      <div className="a-topbar-right">
        ...
        >
          <FiSearch />
          <span className="a-kbd-hint" style={{ position: 'absolute', bottom: -2, right: -2, fontSize: 9 }}>
            /
          </span>
        </button>
        <NotificationBell />
